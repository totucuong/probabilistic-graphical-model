...
function [MEU OptimalDecisionRule] = OptimizeWithJointUtility( I )
  ...
  AdditiveUtilityFactor = I.UtilityFactors(1);
  for i=2:length(I.UtilityFactors)
      AdditiveUtilityFactor = FactorSum(AdditiveUtilityFactor, I.UtilityFactors(i));
  end
  I.UtilityFactors = AdditiveUtilityFactor;
