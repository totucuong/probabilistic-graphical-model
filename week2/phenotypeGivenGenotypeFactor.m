...
%    alphaIdx = A(i,end);
%    if A(i,1) == 1
%        v = [v alphaList(alphaIdx)];
%    else
%        v = [v (1-alphaList(alphaIdx))];
%    end
% end
n = length(alphaList);
physicalTraitsAssignments = [ones(n,1) (1:n)'];
phenotypeFactor = SetValueOfAssignment(phenotypeFactor, physicalTraitsAssignments, alphaList);
nonPhysicalTraitAssignments = [2*ones(n,1) (1:n)'];
phenotypeFactor = SetValueOfAssignment(phenotypeFactor, nonPhysicalTraitAssignments, 1- alphaList);
